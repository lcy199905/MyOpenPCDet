...
class MyPillarNet(Detector3DTemplate):
    ...
    def get_module_loss(self, batch_dict):
        ...
        for b in range(B):
            ...
            if self.mlp_loss:
                ...
                if self.loss_type == 'bce':
                    valid_batch_mlp_xyz = \
                    roiaware_pool3d_utils.points_in_boxes_gpu(batch_mlp_xyz[None, :], batch_gt_boxes)[0]
                elif self.loss_type == 'focal':
                    valid_batch_mlp_xyz = \
                    roiaware_pool3d_utils.points_in_boxes_gpu(batch_mlp_xyz[None, :], batch_gt_boxes)[0]
                    ...
                    valid_batch_mlp_xyz = \
                    roiaware_pool3d_utils.points_in_gaussian_boxes_gpu(batch_mlp_xyz[None, :], batch_gt_boxes)[0]
            ...
            if self.zbam_loss:
                ...
                if self.loss_type in ['bce', 'focal']:
                    valid_batch_zbam_xyz = \
                    roiaware_pool3d_utils.points_in_boxes_gpu(batch_zbam_xyz[None, :], batch_gt_boxes)[0]
                elif self.loss_type == 'gaussian':
                    valid_batch_zbam_xyz = \
                    roiaware_pool3d_utils.points_in_gaussian_boxes_gpu(batch_zbam_xyz[None, :], batch_gt_boxes)[0]
